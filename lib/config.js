...
function getConf (argv) {
	...
	const npmrc = {
		// https://mp.weixin.qq.com/s/OL_2Y_mOSezKA36C19BACw
		// npm.taobao.org 改为 npmmirror.com
		// registry: 'https://registry.npmmirror.com',
		// https://npmmirror.com/mirrors/
		'\n\n# Created by': 'npm-config-china\n',
		'# https://npmmirror.com/mirrors'
		...
		'geckodriver-binary-host-mirror': '{bin-mirrors}/geckodriver/v{version}',
		...
		// 'sharp-dist-base-url': '{bin-mirrors}/sharp-libvips/v{version}', // 移除
		'sharp_binary_host': '{bin-mirrors}/sharp',
		'sharp_libvips_binary_host': '{bin-mirrors}/sharp-libvips',
	};
