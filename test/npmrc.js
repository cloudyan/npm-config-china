...
describe('npm config', () => {
	...
	it('sharp-libvips', () => {
		assert.strictEqual(process.env.npm_config_sharp_dist_base_url, 'https://npmmirror.com/mirrors/sharp-libvips/v{version}');
	});

	it('swc', () => {
		assert.strictEqual(process.env.npm_config_swc_binary_site, 'https://npmmirror.com/mirrors/node-swc');
	});
});
